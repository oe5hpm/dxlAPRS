...
static void iir128(sdr_pRX rx, unsigned long a, unsigned long b)
{
   ...
   do {
      ...
      ph = (unsigned long)((unsigned long)(ph+dfc)&ddslen);
                /* drive mix osz */
      r1 += X2C_DIV(((xr*ddsr-xi*ddsi)-r1)-r3,128L); /* mixer + lowpass i */
      r2 += X2C_DIV(r3-r2,128L);
      r3 += X2C_DIV(r1-r2,64L);
      i1 += X2C_DIV(((xr*ddsi+xi*ddsr)-i1)-i3,128L); /* mixer + lowpass q */
      i2 += X2C_DIV(i3-i2,128L);
      i3 += X2C_DIV(i1-i2,64L);
   } while (i<=b);
   { /* with */
...
static void iir64(sdr_pRX rx, unsigned long a, unsigned long b)
{
   ...
   do {
      ...
      ph = (unsigned long)((unsigned long)(ph+dfc)&ddslen);
                /* drive mix osz */
      r1 += X2C_DIV(((xr*ddsr-xi*ddsi)-r1)-r3,64L); /* mixer + lowpass i */
      r2 += X2C_DIV(r3-r2,64L);
      r3 += X2C_DIV(r1-r2,32L);
      i1 += X2C_DIV(((xr*ddsi+xi*ddsr)-i1)-i3,64L); /* mixer + lowpass q */
      i2 += X2C_DIV(i3-i2,64L);
      i3 += X2C_DIV(i1-i2,32L);
   } while (i<=b);
   { /* with */
      struct sdr_TAP * anonym1 = &rx->tapre;
      anonym1->uc1 = r1;
...
static void iir32(sdr_pRX rx, unsigned long a, unsigned long b)
{
   ...
   do {
      ...
      ph = (unsigned long)((unsigned long)(ph+dfc)&ddslen);
                /* drive mix osz */
      r1 += X2C_DIV(((xr*ddsr-xi*ddsi)-r1)-r3,32L); /* mixer + lowpass i */
      r2 += X2C_DIV(r3-r2,32L);
      r3 += X2C_DIV(r1-r2,16L);
      i1 += X2C_DIV(((xr*ddsi+xi*ddsr)-i1)-i3,32L); /* mixer + lowpass q */
      i2 += X2C_DIV(i3-i2,32L);
      i3 += X2C_DIV(i1-i2,16L);
   } while (i<=b);
   { /* with */
      struct sdr_TAP * anonym1 = &rx->tapre;
      anonym1->uc1 = r1;
...
static void iir16(sdr_pRX rx, unsigned long a, unsigned long b)
{
   ...
   do {
      ...
      ph = (unsigned long)((unsigned long)(ph+dfc)&ddslen);
                /* drive mix osz */
      r1 += X2C_DIV(((xr*ddsr-xi*ddsi)-r1)-r3,16L); /* mixer + lowpass i */
      r2 += X2C_DIV(r3-r2,16L);
      r3 += X2C_DIV(r1-r2,8L);
      i1 += X2C_DIV(((xr*ddsi+xi*ddsr)-i1)-i3,16L); /* mixer + lowpass q */
      i2 += X2C_DIV(i3-i2,16L);
      i3 += X2C_DIV(i1-i2,8L);
   } while (i<=b);
   { /* with */
      struct sdr_TAP * anonym1 = &rx->tapre;
...
static void iir8(sdr_pRX rx, unsigned long a, unsigned long b)
{
   ...
   do {
      ...
      ph = (unsigned long)((unsigned long)(ph+dfc)&ddslen);
                /* drive mix osz */
      r1 += X2C_DIV(((xr*ddsr-xi*ddsi)-r1)-r3,8L); /* mixer + lowpass i */
      r2 += X2C_DIV(r3-r2,8L);
      r3 += X2C_DIV(r1-r2,4L);
      i1 += X2C_DIV(((xr*ddsi+xi*ddsr)-i1)-i3,8L); /* mixer + lowpass q */
      i2 += X2C_DIV(i3-i2,8L);
      i3 += X2C_DIV(i1-i2,4L);
   } while (i<=b);
   { /* with */
         ...
         while (rx[r]) {
            { /* with */
               ...
               if (anonym->maxafc>0UL) {
                  anonym->median = (anonym->median+u)
                -X2C_DIV(anonym->afckhz*1024L,(long)anonym->maxafc);
