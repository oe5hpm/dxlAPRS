...
static void Error(char text[], unsigned long text_len)
{
   ...
   InOut_WriteString("udpflex: ", 10ul);
...
static void WCh(char c0)
{
   if (c0!='\015') {
      ...
      else InOut_WriteString((char *) &c0, 1u/1u);
   }
} /* end WCh() */
...
static void ShowCall(char f[], unsigned long f_len, unsigned long pos)
{
   ...
   if (i0) {
      InOut_WriteString("-", 2ul);
      if (i0>=10UL) {
         InOut_WriteString((char *)(tmp0 = (char)(i0/10UL+48UL),&tmp0),
                1u/1u);
      }
      InOut_WriteString((char *)(tmp0 = (char)(i0%10UL+48UL),&tmp0), 1u/1u);
   }
} /* end ShowCall() */
...
extern int main(int argc, char **argv)
{
   ...
   for (;;) {
      ...
      if (direwolf && tcpfd<0L) {
         if (verb) {
            InOut_WriteString("connect ", 9ul);
            InOut_WriteString(direwolfurl, 2048ul);
            InOut_WriteString(":", 2ul);
               ...
               if (kissm==0UL) {
                ...
                701ul, 0UL, (unsigned long)(upos-1L))==28784UL) || flexmod==2UL && smackcrc(ubuf,
                 701ul, 0UL, (unsigned long)(upos-1L))==0UL) {
                           ...
                           if (hexdump) {
                              if (flexmod==1UL && c==' ') {
                                 InOut_WriteString("FLEX", 5ul);
                              }
                              else if ((unsigned char)c>=(unsigned char)
                '\200') InOut_WriteString("SMACK", 6ul);
                              else {
                                 InOut_WriteString("KISS", 5ul);
                              }
